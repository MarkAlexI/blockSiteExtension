...
const message = chrome.i18n.getMessage(quoteKey);
...
feedbackButton.addEventListener('click', () => {
  ...
  const sendFeedbackSubject = chrome.i18n.getMessage('sendfeedbacksubject');
  const sendFeedbackBody = chrome.i18n.getMessage('sendfeedbackbody');
...
const createBlockThisSiteButton = (url, favIconUrl = 'images/icon-32.png') => {
  ...
  const blockThat = chrome.i18n.getMessage('blockthat');
