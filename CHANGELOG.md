...
## [5.0.0] - 2026-08-15
### Added
- Added Pro Daily Limits for individual blocking rules, allowing a site until its daily focused-use budget is exhausted and then blocking it through the existing DNR engine.
...
- Added regression coverage for blocking-mode validation, usage accounting, URL matching, migration, DNR activation, mutation security, and localization.
